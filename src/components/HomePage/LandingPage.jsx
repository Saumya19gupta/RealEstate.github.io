...
const LandingPage = () => {
  ...
  return (
    <div className="p-10">
      <h2 className="text-2xl font-bold mb-4">Search Results in {cityName}</h2>
      <p className="text-lg">You searched for: <strong>{query}</strong></p>

      {/* Here you can render property cards fetched from API/database based on city and query */}
    </div>
  );
};
...
//                 onChange={handleChange}
//                 placeholder="Provide a short description of your property"
//                 className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 px-3 py-2"
//                 required
//               ></textarea>
//             </div>
